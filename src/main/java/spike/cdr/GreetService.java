 ...
 * 
 * @deprecated <em> Auto-generated code, to be removed! </em>
 */
@Deprecated
public class GreetService implements Service {

	/**
	 * This gets config from application.yaml on classpath and uses "app" section.
	 */
	...
	public final void update(final Routing.Rules rules) {
		rules.get("/", this::getDefaultMessage).get("/{name}", this::getMessage).put("/greeting/{greeting}",
				this::updateGreeting);
	}
	...
	private void updateGreeting(final ServerRequest request, final ServerResponse response) {
		...
		JsonObject returnObject = Json.createObjectBuilder().add("greeting", greeting).build();
		response.send(returnObject);
	}
}
